...
class SearchWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.enter_name_label = QLabel("Enter the name", self)  # Label for entering name
        self.enter_name_label.setGeometry(50, 20, 280, 20)
        self.enter_name_label.setFont(QFont("Arial", 14))
        ...
        self.display_button.setFont(QFont("Arial", 14))
